...
## Skills 
- **Product Management:** PRDs, Feature Prioritization (RICE & CIRCLES), OKRs, Competitive Analysis, Agile/Scrum Practices, GTM Strategy, Vibe Coding, Wireframing  
- **Analytics & Tools:** SQL, Python, Google Analytics, Metabase, Excel, Figma, Miro, Notion 
- **Soft Skills:** Cross-Functional Collaboration, Stakeholder Management, Communication, Problem Solving, Strategic Thinking  

---

## Work Experience
- **Dermatouch** – Worked at the intersection of product operations, analytics, and automation, supporting HR, customer experience, and logistics systems. Owned process discovery, requirements gathering, and workflow design across platforms like Zoho Recruit, Zoho People, ClickPost, Rootle, and Limechat. Led AI-driven automation initiatives to reduce RTO and NDR rates, defined product success metrics (CSAT, NPS, CES, SLA), and built dashboards to improve execution visibility. Focused on translating business problems into scalable, data-backed product solutions adopted across teams.
- **The Bridgeman** – Worked on customer analytics, experimentation, and growth strategy for D2C and restaurant brands. Built customer personas using behavioral data, ran A/B experiments across creative and targeting strategies, and optimized campaigns to improve engagement, CTR, and acquisition ROI. Supported brand positioning and go-to-market execution while collaborating closely with clients on campaign strategy and content operations.
- **Azista Industries (SpaceTech-Internship)** – Automated swath-width and TDI simulations using Python and GMAT, reducing computation time by 80–85%, improving image accuracy, and contributing to 3–5% fuel efficiency in payload design.
...
- **Decathlon Sports India (Internship)** – Improved stock accuracy to 95% and reduced stockouts by 5–7% through enhanced forecasting and WMS-based monitoring; analyzed badminton racket performance, uncovering 8–10% grip issues and recommending supplier review.
